...
public:
 ...
 void SetLLCBnk (int llc_bnk) {
  ...
  void LoadFromXml(TiXmlHandle root) {
     ...
     CacheRootPtr->QueryIntAttribute   ("llc_nbnk"         , &m_llc_bnk         );
     ...
     CacheRootPtr->QueryIntAttribute   ("globalQueues_en"  , &globalQueues_en );
