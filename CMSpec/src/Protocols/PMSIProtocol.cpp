...
namespace ns3
{
    PMSIProtocol::PMSIProtocol(CacheDataHandler *cache, const string &fsm_path, int coreId, vector<int> sharedMemId) : MSIProtocol(cache, fsm_path, coreId, sharedMemId)
    {
    }
