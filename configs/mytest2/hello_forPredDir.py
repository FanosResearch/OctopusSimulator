...
if BM_name == "FFT":
    ...
    args = ["-p" + str(num_cores)] #octo = 170m40s(m16) 10m21(m12) 12m34(m12 + 4steps) 10m23(m12 + 2steps) 7m29(m12, O3 1step) 7585.15 (m16, O3, 330756kb) 6845 (m16, O3, 328936Kb), gem5 = 104m5s(m16) 6m3(m12) 4m1(m12, O3) 5730.58s (m16, O3, 742160kb)
elif BM_name == "LU":
    ...
    args = ["-p" + str(num_cores)] #OCto= O3 10981s 431532Kb, gem5 = O3 7620s 732232Kb, O3 7930s 732368KB new
elif BM_name == "RADIX":
