...
namespace MCsim
{
	...
	public:
		...
		unsigned int getRequestorSize(bool requestor, unsigned int index);
		...
		Request *getRequestorRequest(unsigned int reqIndex, unsigned int index);
		...
		void removeRequest();
		void removeRequest(unsigned int requestor, unsigned long long id);
		void resetScheduledFlag (unsigned int requestor, unsigned long long id);
