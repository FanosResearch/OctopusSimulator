...
namespace ns3
{
    ...
    CacheControllerExclusive::CacheControllerExclusive(CacheXml &cacheXml, string &fsm_path, CommunicationInterface *upper_interface,
                                     ...
                                     vector<int> sharedMemId, CohProtType pType, int order) : CacheController(cacheXml, fsm_path, upper_interface,
                                     lower_interface, cach2Cache, sharedMemId, pType, order)
    {
