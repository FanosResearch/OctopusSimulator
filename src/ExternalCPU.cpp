...
namespace ns3
{
    ...
    ExternalCPU::ExternalCPU(int id, CommunicationInterface *upper_interface) : ClockedObj(1)
    {
        m_id = id;
        m_clk_cycle = 1;
    ...
    void ExternalCPU::addRequests2ProcessingQueue(ProcessingBuffer<Message> &buf)
    {
        Message msg;
    ...
    EntryState ExternalCPU::getRequestState(const Message &msg, EntryState current_state)
    {
