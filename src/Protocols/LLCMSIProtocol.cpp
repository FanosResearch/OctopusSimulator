...
namespace ns3
{
    ...
    EntryState LLCMSIProtocol::getRequestState(const Message &msg, EntryState req_state)
    {
        ...
        //     return EntryState::Ready;
        // else if (req_state == EntryState::Waiting) // replacement request is previously issued
