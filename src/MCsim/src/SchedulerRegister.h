...
#include "../system/FRFCFS_cap/RequestScheduler_FRFCFS_cap.h"
...
#include "../system/RROF/CommandScheduler_RROF.h"
#include "../system/RROF/RequestScheduler_RROF.h"
...
namespace MCsim
{
	...
	public:
		SchedulerRegister(unsigned int dataBus, const map<unsigned int, bool> &requestorTable,
						  vector<RequestQueue *> &requestQueues, vector<CommandQueue *> &commandQueues, RequestorsQueues &requestorsQueues)
		{
			...
			requestSchedulerTable["FRFCFS_cap"] = new RequestScheduler_FRFCFS_cap(requestQueues, commandQueues, requestorTable);
			...
			requestSchedulerTable["RROF"] = new RequestScheduler_RROF(requestQueues, commandQueues, requestorTable, requestorsQueues);
			...
			commandSchedulerTable["RROF"] = new CommandScheduler_RROF(requestQueues,commandQueues, requestorTable, requestorsQueues);
