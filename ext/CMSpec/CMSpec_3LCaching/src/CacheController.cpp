...
namespace ns3
{
    ...
    void CacheController::processLogic()
    {
        ...
        while(true)
        {
            ...
            // if(ready_msg.msg_id == 248053)
            //     cout << ready_msg.msg_id << endl;
            // if((ready_msg.addr & 0xFFFFFFFFFFC0) == 36824384)
            //     cout << ready_msg.msg_id << endl;
    ...
    void CacheController::addtoPendingRequests(void *data_ptr)
    {
        ...
        this->m_pending_cpu_requests[this->getAddressKey(msg->addr)].push_back(*msg);
    ...
    void CacheController::removePendingAndRespond(void *data_ptr)
    {
        ...
        {
            vector<Message> pending_messages = this->m_pending_cpu_requests[this->getAddressKey(msg->addr)];
