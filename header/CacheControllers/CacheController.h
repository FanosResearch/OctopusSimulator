...
namespace ns3
{
    ...
    protected:
        ...
        Arbiter* createArbiter(string arbiter_type, vector<int>* candidates_ids, int arbiter_period = 0);

        virtual void cycleProcess() override;
        virtual void addRequests2ProcessingQueue(ProcessingBuffer<Message> &) override;
        ...
        virtual bool getDataFromDataAccessBuf(Message *msg);
        virtual void checkReplacements(ProcessingBuffer<Message> &);
