...
#include "../Arbiters/TDMArbiter.h"
#include "../Arbiters/FCFSArbiter.h"
#include "../Arbiters/RRArbiter.h"
...
namespace ns3
{
    ...
    public:
        BusController(vector<CommunicationInterface *> *interfaces, vector<int> *lower_level_ids, string memArb);
        ~BusController();
