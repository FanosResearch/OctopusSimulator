...
#define MAX_NAME_SIZE   256       // was 100; deep param names can exceed
#define MAX_TYPE_SIZE   10
#define MAX_STRING_SIZE 4096      // was 100; long absolute paths (WSL-mounted
                                  // Windows paths can be 200+ chars) overflowed
                                  // the buffer in Configurable::parseLine
